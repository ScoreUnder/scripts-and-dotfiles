(define look-on-key '("zenkaku-hankaku"))
(define look-on-key? (make-key-predicate '("zenkaku-hankaku")))
(define look-off-key '("zenkaku-hankaku"))
(define look-off-key? (make-key-predicate '("zenkaku-hankaku")))
